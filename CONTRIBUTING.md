...
de código ([enlace](https://github.com/weincoder/flutter-cicd-rm/wiki/Convenciones-de-Software)) las pruebas de software deben seguir la siguiente convención 
([enlace](https://github.com/weincoder/flutter-cicd-rm/wiki/Pruebas-de-Software-convenciones)). En este proyecto manejamos el siguiente estándar para el manejo de ramas ([enlace](https://github.com/weincoder/flutter-cicd-rm/wiki/DevOps-%E2%80%90-Definiciones))
